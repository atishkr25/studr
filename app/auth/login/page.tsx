    ...
    <div className="flex items-start gap-2.5 rounded-[5px] border border-[#cc3737]/20 bg-[#f4eee5] px-3.5 py-3 text-[#cc3737] text-[13px] font-normal mb-4">
      ...
      <span className="leading-relaxed">
        {error === 'auth_callback_failed'
          ? 'Authentication link expired or is invalid. Please try requesting a new one.'
          : error}
      </span>
    </div>
  )
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    ...
                    className="text-[12px] text-[#0A7C6E] hover:underline font-medium focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[#0A7C6E] rounded"
                  >
                    Forgot password?
                  </Link>
                </div>
